...
(function() {
  var app, config, db, dbconnection, express, http, iniparser, isEmptyObject, latestwhitelist, mongo, mongoStore, monk, pageskip, password, port, prodMode, sitename, sitetag, sitetitle, username;
  ...
  app.get('/archive', function(req, res) {
    var blogposts, complete, pageresults, postresults, sitepages;
    if (req.session.admin) {
      ...
      return complete = function() {
        if (pageresults !== null && postresults !== null) {
